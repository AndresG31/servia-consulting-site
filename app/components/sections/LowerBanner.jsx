...
const LowerBanner = () => {
  return (
    <section data-header-theme="light" className="relative bg-white py-16 overflow-hidden">
        ...
        <div className="text-center space-y-6">
          ...
          <div className="grid sm:grid-cols-3 gap-6 pt-6 pb-8">
            <div className="flex flex-col items-center space-y-2">
              ...
              <h3 className="font-semibold text-emerald-900">Save Up to 25%</h3>
              <p className="text-sm text-gray-600">Special bundle pricing</p>
            </div>
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              <h3 className="font-semibold text-emerald-900">Complete Solution</h3>
              <p className="text-sm text-gray-600">Strategy + Technology</p>
            </div>
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              <h3 className="font-semibold text-emerald-900">Faster Results</h3>
              <p className="text-sm text-gray-600">Integrated implementation</p>
            </div>
          </div>

          {/* CTA Button */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
            <Link href="/service" className="bg-emerald-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-emerald-700 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 inline-flex items-center gap-3">
            ...
            <Link href="/contact" className="bg-transparent border-2 border-emerald-600 text-emerald-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-emerald-600/10 transition-all inline-flex items-center gap-3">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-emerald-600/20 to-transparent"></div>
    </section>
  )
}
