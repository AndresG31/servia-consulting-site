...
const MiddleBanner = () => {
  return (
    <section data-header-theme="dark" className="relative bg-black py-16 overflow-hidden">
      {/* Grid pattern background */}
      <div className="absolute inset-0 -z-10" style={{
        backgroundImage: `linear-gradient(to right, rgba(5, 150, 105, 0.2) 1px, transparent 1px),
      ...
      <div className="absolute top-8 right-8 w-12 h-12 border-2 border-emerald-400/40 rounded-lg -rotate-12 animate-pulse"></div>
      <div className="absolute bottom-8 left-8 w-12 h-12 border-2 border-emerald-400/40 rounded-lg rotate-12 animate-pulse"></div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div className="text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
            ...
            <Link href="/about" className="bg-transparent border-2 border-emerald-400 text-emerald-400 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-emerald-400/10 transition-all inline-flex items-center gap-3">
              Learn More
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
