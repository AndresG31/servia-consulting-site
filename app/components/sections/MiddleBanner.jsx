...
const MiddleBanner = () => {
  return (
    <section data-header-theme="light" className="relative bg-white py-16 overflow-hidden">
      ...
      <div className="absolute top-8 right-8 w-12 h-12 border-2 border-emerald-600/30 rounded-lg -rotate-12 animate-pulse"></div>
      <div className="absolute bottom-8 left-8 w-12 h-12 border-2 border-emerald-600/30 rounded-lg rotate-12 animate-pulse"></div>
        ...
        <div className="text-center space-y-6">
          ...
          <div className="grid sm:grid-cols-3 gap-6 pt-6 pb-8">
            <div className="flex flex-col items-center space-y-2">
              ...
              <h3 className="font-semibold text-emerald-900">Deep Analysis</h3>
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              <h3 className="font-semibold text-emerald-900">Data-Driven Insights</h3>
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              <h3 className="font-semibold text-emerald-900">Growth Strategy</h3>
              <p className="text-sm text-gray-600">Customized roadmap</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
            ...
            <Link href="/about" className="bg-transparent border-2 border-emerald-600 text-emerald-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-emerald-600/10 transition-all inline-flex items-center gap-3">
              Learn More
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
