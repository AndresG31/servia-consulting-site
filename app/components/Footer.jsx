...
const Footer = () => {
  return (
    <footer className="relative bg-black text-white overflow-hidden section-transition section-delay-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="space-y-6 fade-slide-up text-delay-1">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white">Servia</h3>
                  <p className="text-emerald-400 text-sm font-semibold">Consulting</p>
                </div>
              </div>
              ...
              <div className="flex space-x-4 pt-2">
                <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-emerald-600 rounded-lg flex items-center justify-center transition-all group">
            ...
            <div className="fade-slide-up text-delay-3">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3 group">
                  <div className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-emerald-600 transition-colors">
            ...
            <div className="fade-slide-up text-delay-4">
              ...
              {/* Emergency Contact */}
              <div className="mt-6 p-4 bg-gray-900 rounded-lg border border-emerald-600/30">
